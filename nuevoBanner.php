...
?>
    ...
    <form class="container" action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="administracion mb-10">
        ...
        <div class="mb-5">
            ...
            <input type="file" class="form-control" name="foto" id="" placeholder="Banner">
        ...
        <label for="" class="mb-3">Fecha de Publicación</label>
            <input type="date" class="form-control" name="fecha" id="" placeholder="Fecha de Publicación">
